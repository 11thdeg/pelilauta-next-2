...
<template>
  <Column class="double">
    <section>
      <h1>Stylebook</h1>
      <p>
        This page acts as a kind of a testing scaffold and a Diary for the UX and UI design for the app. Additionally, it is a
      ...
      <p>
        ...
        views can be found from the default location <span class="code">@/views</span>
      </p>
